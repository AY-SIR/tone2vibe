...
export class AnalyticsService {
  ...
  /** ------------------------------
   * Map language codes → human-readable
   * ------------------------------- */
  static formatLanguageCode(code: string): string {
    const languageNames: Record<string, string> = {
      'en-US':'English (US)','en-GB':'English (UK)','hi-IN':'Hindi','bn-IN':'Bengali (IN)',
      'fr-FR':'French','es-ES':'Spanish','de-DE':'German','ja-JP':'Japanese','ar-SA':'Arabic',
