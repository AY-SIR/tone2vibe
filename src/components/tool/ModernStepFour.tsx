...
const ModernStepFour = ({
  ...
  // Mock profile data - replace with real auth
  const profile = { plan: 'premium' }; // Change to 'free', 'pro', or 'premium' to test
  ...
  const handleGenerateSample = async () => {
    ...
    try {
      ...
      setProgress(100);
      setSampleAudio("https://example.com/sample.mp3");
      
      // Auto-expand settings for paid users after sample
      if (isPaidUser && !showAdvanced) {
        setShowAdvanced(true);
      }
      
      console.log("Sample Ready! Listen and adjust settings if needed, then approve or regenerate.");
    } catch (error) {
  ...
  const handleApproveSample = () => {
    ...
    console.log("Great Choice! Your voice settings are locked in. Ready to generate your full audio!");
  };
  ...
  const handleGenerateFullAudio = async () => {
    ...
    try {
      ...
      clearInterval(progressInterval);
      setProgress(100);
      const audioUrl = "https://example.com/full-audio.mp3";
      setGeneratedAudio(audioUrl);
      onAudioGenerated(audioUrl);
      
      console.log(`Success! Your Audio is Ready. Created ${Math.ceil(wordCount / 150)} minutes of high-quality audio.`);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Advanced Settings - ONE CARD FOR ALL PLANS */}
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="flex items-center text-lg">
              ...
              {profile?.plan === 'pro' && <Badge variant="secondary" className="ml-2 text-xs">Pro</Badge>}
            </CardTitle>
            {profile?.plan === 'free' ? (
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  if (!showAdvanced && sampleAudio) {
                    ...
                    console.log("Settings changed - Generate a new sample with updated settings");
                  }
                }}
                className="text-sm"
              >
        ...
        {/* PRO PLAN - Basic Settings Only */}
        {profile?.plan === 'pro' && showAdvanced && (
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between border-b pb-2">
              <h4 className="font-semibold text-sm text-gray-700">Pro Controls</h4>
        ...
        {/* PREMIUM PLAN - Basic + Premium Fine-Tune Settings */}
        {profile?.plan === 'premium' && showAdvanced && (
          <CardContent className="space-y-6">
            {/* Basic Settings */}
            <div className="space-y-4">
              <div className="flex items-center justify-between border-b pb-2">
                <h4 className="font-semibold text-sm text-gray-700">Basic Controls</h4>
            ...
            {/* Premium Fine-Tune Settings - ALWAYS VISIBLE IN PREMIUM */}
